...
def load_ratio_data():
    ...
    p_path = r"https://github.com/sizipusx/fundamental/blob/04eefea1ffe5ec89459913bedf03f49a4a7aa359/files/kb_price.xlsx?raw=True"
...
if __name__ == "__main__":
    ...
    if my_choice == 'Basic':
        ...
        if submit:
            drawAPT.run_local_analysis(mdf, jdf, mdf_change, jdf_change, city_list, small_list, mirco_list, selected_dosi, selected_dosi2, selected_dosi3)
