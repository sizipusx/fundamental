...
def draw_sentiment_change(selected_dosi, mdf_change, js_index):
    ...
    fig.add_shape(type="line", x0=js_index.index[0], y0=mdf_change[selected_dosi].mean(), x1=js_index.index[-1], y1=mdf_change[selected_dosi].mean(), line=dict(color="MediumPurple",width=2, dash="dot"))
