...
def draw_basic():
    ...
    with tab2:
        ...
        drawAPT_weekly.displot(kb_last_jdf, last_ojdf, flag='전세가격')
        with st.container():
            col1, col2, col3 = st.columns([30,2,30])
            with col1:
    ...
    if my_choice == '한주 동향':
        ...
        if submit:
            ...
            with st.container():
                ...
                with col1:
                    flag = 'KB 주간'
                    drawAPT_weekly.draw_index_change_with_bubble(change_df, flag, round(diff.days/365,1) + "년")

                with col2:
                    st.write("")
                with col3:
                    flag = '부동산원 주간'
                    drawAPT_weekly.draw_index_change_with_bubble(change_odf, round(diff.days/365,1) + "년")
