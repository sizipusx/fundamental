    ...
    with st.container():
        ...
        with col1:
            ...
            for y_data, color in zip(y_data_bar, marker_colors1) :
                fig.add_trace(go.Bar(name = y_data+'(R)', x = x_data, y = df1.loc[:,y_data], marker_color= color,
        ...
        with col3: 
            ...
            for y_data, color in zip(y_data_bar, marker_colors1) :
                fig.add_trace(go.Bar(name = y_data+'(R)', x = x_data, y = df2.loc[:,y_data], marker_color= color,
